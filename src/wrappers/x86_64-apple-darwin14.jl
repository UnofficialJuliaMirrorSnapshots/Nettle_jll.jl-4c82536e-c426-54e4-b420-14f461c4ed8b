# Autogenerated wrapper script for Nettle_jll for x86_64-apple-darwin14
...
const libhogweed_splitpath = ["lib", "libhogweed.4.5.dylib"]
...
const libhogweed = "@rpath/libhogweed.4.dylib"


# Relative path to `libnettle`
const libnettle_splitpath = ["lib", "libnettle.6.5.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libnettle = "@rpath/libnettle.6.dylib"
